...
const resources = {
  en: {
    translation: {
      ...
      // Footer
      'footer.disclaimer': 'LexMeet is a technology platform only. This is not a substitute for professional legal advice.',
  ...
  te: {
    translation: {
      ...
      'doc.rent.price': '₹499',
      'doc.freelance.title': 'ఫ్రీలాన్స్ కాంట్రాక్ట్',
      ...
      // Footer
      'footer.disclaimer': 'LexMeet సాంకేతిక వేదిక మాత్రమే. ఇది వృత్తిపరమైన న్యాయ సలహాకు ప్రత్యామ్నాయం కాదు.',
